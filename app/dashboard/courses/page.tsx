      ...
      <div id="videos-grabados" className="mt-12 bg-white rounded-xl shadow-lg p-8">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          <div className="bg-gray-50 rounded-lg p-6 text-center">
            ...
            <a href="https://iframe.mediadelivery.net/play/481547/5bb91813-21a3-428e-ae3a-78a9b03ecf63" target="_blank" rel="noopener noreferrer" className="bg-blue-600 text-white px-4 py-2 rounded-lg text-sm hover:bg-blue-700 transition-colors inline-block">Ver Sesión 1</a>
          </div>
