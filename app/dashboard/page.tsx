          ...
          <div className="p-6">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div className="text-white">
                  ...
                  <p className="text-green-100 text-sm mt-1">
                    Únete al canal oficial del Programa de Transformación Digital
                  </p>
                  <div className="flex items-center space-x-4 mt-2 text-green-100 text-xs">
              ...
              <div className="text-center">
                <a 
                  href="https://whatsapp.com/channel/0029VbB12Ph3gvWTMYsGWx3r" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="bg-white text-green-600 hover:bg-green-50 font-bold py-3 px-6 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-2"
                >
              ...
              <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg shadow-lg p-6 mb-6">
                <div className="flex items-center justify-between">
                  <div className="text-white">
                    ...
                    <h3 className="text-xl font-bold mb-1">
                      Sesión 1: Transformación Digital Norte de Caldas
                    </h3>
                    <p className="text-blue-100 text-sm mb-2">
                      Miércoles 27 de Agosto • Duración: 1h 30min
                    </p>
                    <p className="text-blue-200 text-sm">
                      Primera sesión del programa - Conceptos fundamentales y introducción
                    </p>
                  </div>
                  
                  <div className="text-right">
                    <a 
                      href="https://iframe.mediadelivery.net/play/481547/5bb91813-21a3-428e-ae3a-78a9b03ecf63" 
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="bg-white text-blue-600 hover:bg-blue-50 font-bold py-3 px-6 rounded-lg shadow-lg transition-all duration-300 hover:scale-105 flex items-center space-x-2 mb-2"
                    >
                ...
                <div className="mt-4 pt-4 border-t border-white/20">
                  <div className="grid grid-cols-3 gap-4 text-center text-white">
                    <div>
                      <div className="text-lg font-bold">1h 30m</div>
                      <div className="text-xs text-blue-200">Duración</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold">HD</div>
                      <div className="text-xs text-blue-200">Calidad</div>
                    </div>
                    <div>
                      <div className="text-lg font-bold">∞</div>
                      <div className="text-xs text-blue-200">Acceso</div>
                    </div>
                  </div>
                </div>
              </div>
